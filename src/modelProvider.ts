...
export class ModelProvider {
    ...
    public provideTextDocumentContent(rootUri: vscode.Uri, models: string) {
        const d3LibraryPath = rootUri.toString() + path.sep + 'node_modules' + path.sep + 'd3' + path.sep + 'dist' + path.sep + 'd3.js';
        const dagreD3LibrabryPath = rootUri.toString() + path.sep + 'node_modules' + path.sep + 'dagre-d3' + path.sep + 'dist' + path.sep + 'dagre-d3.js';
        const vueLibraryPath = rootUri.toString() + path.sep + 'node_modules' + path.sep + 'vue' + path.sep + 'dist' + path.sep + 'vue.js';
        const d3LegendLibraryPath = rootUri.toString() + path.sep + 'node_modules' + path.sep + 'd3-svg-legend' + path.sep + 'd3-legend.js';
        const cssFilePath = rootUri.toString() + path.sep + 'css' + path.sep + 'app.css';
